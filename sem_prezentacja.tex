...
\begin{frame}{Dlaczego odwrócone wahadło?}
	\only<1>{
		\begin{figure}[!htp]
			\includegraphics[width=0.4\textwidth]{img/balans1}
	...
	\only<2->{
		Dlaczego wybraliśmy odwrócone wahadło jako obiekt sterowania
		regulatorem rozmytym?                          \pause
		\begin{itemize}
			\item obiekt nieliniowy,                   \pause
			\item trudność w sterowaniu,               \pause
